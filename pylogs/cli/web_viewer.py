...
"""
PyLogs Web Viewer CLI

This module provides a command-line interface for the PyLogs web viewer.
"""
...
from pylogs.web.app import run_app
...
def main(host, port, db, debug):
    ...
    click.echo(f"Starting PyLogs web viewer on http://{host}:{port}")
